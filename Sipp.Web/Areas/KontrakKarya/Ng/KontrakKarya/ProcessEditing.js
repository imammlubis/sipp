...
//==============================================UPLOAD DATA================================================//
    ...
    $scope.CreateDataAkta = function () {
        ...
        $http.post('/KontrakKarya/memasukandata/CreateDataAkta', {
            ID: '-',
            CompanyID: $scope.idx,
    ...
    $scope.deleteDataAkta = function (id) {
        swal({
            ...
            $http.post('/KontrakKarya/MemasukanData/DeleteDataAkta', { id: id })
            .success(function (data) {
                $scope.loadAkta();
    ...
    $scope.loadAkta = function () {
        $http.get('/KontrakKarya/memasukandata/LoadAkta/' + $scope.idx)
        .success(function (data) {
    ...
    $scope.editDataAktaClick = function (id) {
        $http.get('/KontrakKarya/memasukandata/FindDataAkta/' + id)
        .success(function (data) {
            debugger;
    ...
    $scope.SaveChangesDataAkta = function (id) {
        debugger;
        $http.post('/KontrakKarya/memasukandata/EditServiceDataAkta/', {
    ...
    $scope.CreatePersetujuan = function () {
        ...
        //if ($scope.dataAktaForm.$invalid) { return; }
        toastr["info"]("Menyimpan Data..");
        $http.post('/KontrakKarya/memasukandata/CreatePersetujuan', {
            ID: '-',
            CompanyID: $scope.idx,
    ...
    $scope.loadPersetujuan = function () {
        $http.get('/KontrakKarya/memasukandata/LoadPersetujuan/' + $scope.idx)
        .success(function (data) {
    ...
    $scope.deleteDataPersetujuan = function (id) {
        swal({
            ...
            $http.post('/KontrakKarya/MemasukanData/DeletePersetujuan', { id: id })
            .success(function (data) {
                $scope.loadPersetujuan();
                swal("Sukses!", "Data telah dihapus", "success");
            })
    ...
    $scope.editDataPersetujuanClick = function (id) {
        $http.get('/KontrakKarya/memasukandata/FindDataPersetujuan/' + id)
        .success(function (data) {
            debugger;
    ...
    $scope.SaveChangesDataPersetujuan = function (id) {
        debugger;
        $http.post('/KontrakKarya/memasukandata/EditServiceDataPersetujuan/', {
    ...
    $scope.CreateKronologiTahapan = function () {
        ...
        //if ($scope.dataAktaForm.$invalid) { return; }
        toastr["info"]("Menyimpan Data..");
        $http.post('/KontrakKarya/memasukandata/CreateKronologiTahapan', {
            ID: '-',
            CompanyID: $scope.idx,
    ...
    $scope.loadKronologiTahapan = function () {
        $http.get('/KontrakKarya/memasukandata/LoadKronologiTahapan/' + $scope.idx)
        .success(function (data) {
    ...
    $scope.deleteKronologiTahapan = function (id) {
        swal({
            ...
            $http.post('/KontrakKarya/MemasukanData/DeleteKronologiTahapan', { id: id })
            .success(function (data) {
                $scope.loadKronologiTahapan();
                swal("Sukses!", "Data telah dihapus", "success");
            })
    ...
    $scope.editKronologiTahapanClick = function (id) {
        $http.get('/KontrakKarya/memasukandata/FindKronologiTahapan/' + id)
        .success(function (data) {
            debugger;
    ...
    $scope.SaveChangesKronologiTahapan = function (id) {
        debugger;
        $http.post('/KontrakKarya/memasukandata/EditServiceKronologiTahapan/', {
    ...
    $scope.tambahDetailKronologiTahapanClick = function () {
        $scope.initDetailKronologiTahapanModel();
        //dataDetailKronologiTahapanForm
    ...
    $scope.CreateDetailKronologiTahapan = function () {
        ...
        //if ($scope.dataAktaForm.$invalid) { return; }
        toastr["info"]("Menyimpan Data..");
        $http.post('/KontrakKarya/memasukandata/CreateDetailKronologiTahapan', {
            ID: '-',
            CompanyID: $scope.idx,
    ...
    $scope.loadDetailKronologiTahapan = function () {
        $http.get('/KontrakKarya/memasukandata/LoadDetailKronologiTahapan/' + $scope.idx)
        .success(function (data) {
    ...
    $scope.deleteDetailKronologiTahapan = function (id) {
        swal({
            ...
            $http.post('/KontrakKarya/MemasukanData/DeleteDetailKronologiTahapan', { id: id })
            .success(function (data) {
                $scope.loadDetailKronologiTahapan();
                swal("Sukses!", "Data telah dihapus", "success");
            })
    ...
    $scope.editDetailKronologiTahapanClick = function (id) {
        $http.get('/KontrakKarya/memasukandata/FindDetailKronologiTahapan/' + id)
        .success(function (data) {
            debugger;
            //ID = data.ID,
    ...
    $scope.SaveChangesDetailKronologiTahapan = function (id) {
        debugger;
        $http.post('/KontrakKarya/memasukandata/EditServiceDetailKronologiTahapan/', {
    ...
    $scope.loadBiayaEksplorasi = function () {
        $http.get('/kontrakkarya/memasukandata/loadBiayaEksplorasi/' + $scope.idx)
        .success(function (data) {
    ...
    $scope.SaveEditBiayaEksplorasi = function () {
        ...
        toastr["info"]("Menyimpan Data..");
        debugger;
        if ($scope.biayaEksplorasiModel.id == null || $scope.biayaEksplorasiModel.id == 'undefined' || $scope.biayaEksplorasiModel.id == '') {
            $http.post('/KontrakKarya/memasukandata/SaveBiayaEksplorasi', {
                ID: '-',
            ...
            $http.post('/KontrakKarya/memasukandata/EditBiayaEksplorasi', {
    ...
    $scope.SaveEditGeneralInformation = function () {        
        ...
        toastr["info"]("Menyimpan Data..");
        $http.post('/KontrakKarya/memasukandata/EditServiceGeneralInformation', {
            ID: $scope.idx,
            ...
            Komoditi: $('#komoditi').val().toString(),
            Lainnya: $scope.dataPkp2bModel.lainnya,
        })
        .success(function (data) {
            if (data == '0')
    ...
    $scope.loadDetails = function () {
        $http.get('/KontrakKarya/memasukandata/LoadDetailsKk/' + $scope.idx)
        .success(function (data) {
           
            //$scope.dataPkp2bModel.komoditi = data.datapkp2b.Komoditi,
            ...
            $scope.dataPkp2bModel.lainnya = data.datapkp2b.Lainnya,
            ...
            var cb = data.datapkp2b.Komoditi.split(',');
            $('.selectpicker').selectpicker('val', cb);
        })
        .finally(function () { })
    }
    $scope.loadDetails();
    ...
    $scope.CreateCadanganBatubara = function () {
        ...
        //if ($scope.dataAktaForm.$invalid) { return; }
        toastr["info"]("Menyimpan Data..");
        $http.post('/KontrakKarya/memasukandata/CreateCadanganBatubara', {
            ID: '-',
    ...
    $scope.loadCadanganBatubara = function () {
        $http.get('/KontrakKarya/memasukandata/loadCadanganBatubara/' + $scope.idx)
        .success(function (data) {
    ...
    $scope.deleteCadanganBatubara = function (id) {
        swal({
            ...
            $http.post('/KontrakKarya/MemasukanData/DeleteCadanganBatubara', { id: id })
            .success(function (data) {
                $scope.loadCadanganBatubara();
                swal("Sukses!", "Data telah dihapus", "success");
            })
    ...
    $scope.editCadanganBatubaraClick = function (id) {
        $http.get('/KontrakKarya/memasukandata/FindCadanganBatubara/' + id)
        .success(function (data) {
    ...
    $scope.SaveChangesCadanganBatubara = function (id) {
        debugger;
        $http.post('/KontrakKarya/memasukandata/EditServiceCadanganBatubara/', {
            //ID: '-',
            //Blok: $scope.cadanganBatubaraModel.blok,
            //Terkira: $scope.cadanganBatubaraModel.terkira,
            //Terbukti: $scope.cadanganBatubaraModel.terbukti,
    ...
    $scope.CreateKadar = function () {
        debugger;
        //if ($scope.dataAktaForm.$invalid) { return; }
        toastr["info"]("Menyimpan Data..");
        $http.post('/KontrakKarya/memasukandata/CreateKadar', {
            ID: '-',
            Komoditi: $scope.kadarModel.komoditi,
            KadarKomoditi: $scope.kadarModel.kadar,
            Blok : $scope.kadarModel.blok,
            SampleCode: $scope.kadarModel.sampleCode,
            CompanyID: $scope.idx
        })
        .success(function (data) {
            $('#static5').modal('hide')
    ...
    $scope.editKadar = function (id) {
        $http.get('/KontrakKarya/memasukandata/FindKadar/' + id)
        .success(function (data) {  
            $scope.kadarModel.ID = data.ID,
            $scope.kadarModel.komoditi = data.Komoditi,
            $scope.kadarModel.blok = data.Blok,
            $scope.kadarModel.sampleCode = data.SampleCode,
            $scope.kadarModel.kadar = data.KadarKomoditi,
            $('#static5').modal('show');
            $scope.isEditKadar = true;
        })
    }
    $scope.SaveChangesKadar = function (id) {
        $http.post('/KontrakKarya/memasukandata/EditServiceKadar/', {
            ID: $scope.kadarModel.ID,
            Komoditi: $scope.kadarModel.komoditi,
            Blok: $scope.kadarModel.blok,
            SampleCode: $scope.kadarModel.sampleCode,
            KadarKomoditi: $scope.kadarModel.kadar,
        ...
        .finally(function () {
            ...
            $('#static5').modal('hide');
            toastr["success"]("Data Berhasil Diubah..");
            $scope.isEditKadar = false;
        })
    }

    $scope.loadKadar = function () {
        $http.get('/KontrakKarya/memasukandata/LoadKadar/' + $scope.idx)
        .success(function (data) {
            $scope.dataKadar = data.data;
        })
    }
    $scope.loadKadar();

    $scope.deleteKadar = function (id) {
        swal({
            title: "Delete Data", text: "Hapus Data? ",
            type: "warning", showCancelButton: true, confirmButtonColor: "#DD6B55",
            confirmButtonText: "Ya, silakan hapus!", closeOnConfirm: false
        }, function () {
            $http.post('/KontrakKarya/MemasukanData/DeleteKadar', { id: id })
            .success(function (data) {
                $scope.loadKadar();
                swal("Sukses!", "Data telah dihapus", "success");
            })
    ...
    $scope.CreateKualitasBatubara = function () {
        ...
        //if ($scope.dataAktaForm.$invalid) { return; }
        toastr["info"]("Menyimpan Data..");
        $http.post('/KontrakKarya/memasukandata/CreateKualitasBatubara', {
            ID: '-',
    ...
    $scope.loadKualitasBatubara = function () {
        $http.get('/KontrakKarya/memasukandata/loadKualitasBatubara/' + $scope.idx)
        .success(function (data) {
    ...
    $scope.deleteKualitasBatubara = function (id) {
        swal({
            ...
            $http.post('/KontrakKarya/MemasukanData/DeleteKualitasBatubara', { id: id })
            .success(function (data) {
                $scope.loadKualitasBatubara();
                swal("Sukses!", "Data telah dihapus", "success");
            })
    ...
    $scope.editKualitasBatubaraClick = function (id) {
        $http.get('/KontrakKarya/memasukandata/FindKualitasBatubara/' + id)
        .success(function (data) {
            debugger;
    ...
    $scope.SaveChangesKualitasBatubara = function (id) {
        debugger;
        $http.post('/KontrakKarya/memasukandata/EditServiceKualitasBatubara/', {
    ...
    $scope.CreateTahapKegiatan = function () {
        ...
        //if ($scope.dataAktaForm.$invalid) { return; }
        toastr["info"]("Menyimpan Data..");
        $http.post('/KontrakKarya/memasukandata/CreateTahapKegiatan', {
    ...
    $scope.loadTahapKegiatan = function () {
        $http.get('/KontrakKarya/memasukandata/loadTahapKegiatan/' + $scope.idx)
        .success(function (data) {
    ...
    $scope.deleteTahapKegiatan = function (id) {
        swal({
            ...
            $http.post('/KontrakKarya/MemasukanData/DeleteTahapKegiatan', { id: id })
            .success(function (data) {
                $scope.loadTahapKegiatan();
                swal("Sukses!", "Data telah dihapus", "success");
            })
    ...
    $scope.editTahapKegiatanClick = function (id) {
        $http.get('/KontrakKarya/memasukandata/FindTahapKegiatan/' + id)
        .success(function (data) {
            debugger;
    ...
    $scope.SaveChangesTahapKegiatan = function (id) {
        debugger;
        $http.post('/KontrakKarya/memasukandata/EditServiceTahapKegiatan/', {
            //ID: '-',
            //Tahap: $scope.tahapKegiatanModel.tahapKegiatan,
            //LuasDipertahankan: $scope.tahapKegiatanModel.luasDipertahankan,
            //CompanyID: $scope.idx
    ...
    $scope.CreateTahapKegiatanBlok = function () {
        ...
        //if ($scope.dataAktaForm.$invalid) { return; }
        toastr["info"]("Menyimpan Data..");
        $http.post('/KontrakKarya/memasukandata/CreateTahapKegiatanBlok', {
            ID: '-',
    ...
    $scope.loadTahapKegiatanBlok = function () {
        $http.get('/KontrakKarya/memasukandata/loadTahapKegiatanBlok/' + $scope.idx)
        .success(function (data) {
    ...
    $scope.deleteTahapKegiatanBlok = function (id) {
        swal({
            ...
            $http.post('/KontrakKarya/MemasukanData/DeleteTahapKegiatanBlok', { id: id })
            .success(function (data) {
                $scope.loadTahapKegiatanBlok();
                swal("Sukses!", "Data telah dihapus", "success");
            })
    ...
    $scope.editTahapKegiatanBlokClick = function (id) {
        $http.get('/KontrakKarya/memasukandata/FindTahapKegiatanBlok/' + id)
        .success(function (data) {
            debugger;
    ...
    $scope.SaveChangesTahapKegiatanBlok = function (id) {
        debugger;
        $http.post('/KontrakKarya/memasukandata/EditServiceTahapKegiatanBlok/', {
    ...
    $scope.CreateSumberDayaBatubara = function () {
        ...
        //if ($scope.dataAktaForm.$invalid) { return; }
        toastr["info"]("Menyimpan Data..");
        $http.post('/KontrakKarya/memasukandata/CreateSumberDayaBatubara', {
            /*
    ...
    $scope.loadSumberDayaBatubara = function () {
        $http.get('/KontrakKarya/memasukandata/loadSumberDayaBatubara/' + $scope.idx)
        .success(function (data) {
    ...
    $scope.deleteSumberDayaBatubara = function (id) {
        swal({
            ...
            $http.post('/KontrakKarya/MemasukanData/DeleteSumberDayaBatubara', { id: id })
            .success(function (data) {
                $scope.loadSumberDayaBatubara();
                swal("Sukses!", "Data telah dihapus", "success");
            })
    ...
    $scope.editSumberDayaBatubaraClick = function (id) {
        $http.get('/KontrakKarya/memasukandata/FindSumberDayaBatubara/' + id)
        .success(function (data) {
            debugger;
    ...
    $scope.SaveChangesSumberDayaBatubara = function (id) {
        debugger;
        $http.post('/KontrakKarya/memasukandata/EditServiceSumberDayaBatubara/', {
            //ID: '-',
            //Blok: $scope.SumberDayaBatubaraModel.blok,
            //Tereka: $scope.SumberDayaBatubaraModel.tereka,
            //Terunjuk: $scope.SumberDayaBatubaraModel.terunjuk,
    ...
    $scope.saveShareholder = function () {
        ...
        if ($scope.isEditShareholder == true) {
            ...
            $http.post('/KontrakKarya/memasukandata/CreateServiceShareHolder', {
                ID: '-',
                Name: $scope.shareholderModel.nama.toUpperCase(),
                CompanyID: $scope.idx,
                TotalStock: $scope.shareholderModel.jumlahSaham,
